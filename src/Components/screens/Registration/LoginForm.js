...
import { passwordType, emailType, LoginUser } from '../../../actions/AuthAction';
            ...
            <KeyboardAvoidingView behavior="padding" style={{ flex: 1, alignItems: 'center', justifyContent: 'center', }}>
                <View >
                    ...
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('Sign')}>
                        <Text style={{ color: '#222', fontSize: 22 }}>Or Sign Up</Text>
                    </TouchableOpacity>
...
export default connect(mapStateToProps, { emailType, passwordType, LoginUser })(LoginForm);
